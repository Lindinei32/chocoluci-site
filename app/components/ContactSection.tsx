// /app/components/ContactSection.tsx - VERSÃO COM A COR DE FUNDO DOS CARDS ATUALIZADA
...
export default function ContactSection() {
  ...
  return (
    <section className="bg-[#f7c1d2] w-full py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-12">
          ...
          {/* A MUDANÇA ESTÁ AQUI: */}
          <div className="bg-[#FFFFF8] rounded-2xl shadow-lg p-8 flex flex-col items-center justify-center">
            ...
            <a
              ...
              className="mt-6 bg-[#f5bcce] text-[#5D4037] font-semibold py-3 px-8 rounded-lg flex items-center justify-center gap-2 transition-transform duration-300 hover:scale-105 w-full"
            >
              <FaComments />
              Iniciar Conversa
            </a>
